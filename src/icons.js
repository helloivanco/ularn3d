...
const paths = {
  sigil:
    '<path d="m12 2 8 9-8 8-8-8 8-9Z"/><path d="m12 7 4 4-4 4-4-4 4-4ZM8 17l-4 5m12-5 4 5"/>',
  swords:
    '<path d="m3 3 5 1 11 12-3 3L4 8 3 3Z"/><path d="m21 3-5 1-4 4m4 4 4-4 1-5M8 12l-3 4 3 3 4-4M3 14l7 7m4 0 7-7M3 21l3-3m12 0 3 3"/>',
  wand: '<path d="m4 20 11-11 3 3L7 23M14 10l3 3M6 3v4M4 5h4m10-3 1.3 3.7L23 7l-3.7 1.3L18 12l-1.3-3.7L13 7l3.7-1.3L18 2Z"/>',
  dagger:
    '<path d="m19 3-1 7-8 7-3-3 7-8 5-3ZM5 12l7 7m-7-2-3 3 2 2 3-3m3-5 6-7"/>',
  ...
  blades:
    '<path d="M3 3v7l6 7h6l6-7V3l-5 8H8L3 3Zm6 14-2 4m8-4 2 4M8 11v3m8-3v3m-4-3v6"/>',
  spear: '<path d="m4 21 11-13m-3 1 2-6 7-2-2 7-6 3m-3 0 4 4m2-9 2-2"/>',
  backpack:
    '<rect x="5" y="6" width="14" height="16" rx="3"/><path d="M9 6V4a3 3 0 0 1 6 0v2M5 11h14m-11 4h8v4H8zM9 10v3m6-3v3"/>',
  spell:
    '<path d="m12 2 2.8 7.2L22 12l-7.2 2.8L12 22l-2.8-7.2L2 12l7.2-2.8L12 2Z"/><path d="M4 3v3M2.5 4.5h3M20 18v4m-2-2h4"/>',
  potion:
    '<path d="M9 3h6M10 3v6l-5 8a3 3 0 0 0 2.5 4.5h9a3 3 0 0 0 2.5-4.5l-5-8V3M7 15h10"/><path d="m10 18 .01 0m4 1 .01 0"/>',
  scroll:
    '<path d="M7 3h12a3 3 0 0 1 3 3v2h-5V6a3 3 0 0 1 3-3M17 8v10a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-2h5V6a3 3 0 0 1 3-3M7 16v2a3 3 0 0 0 3 3m0-12h4m-4 4h4"/>',
  chest:
    '<path d="M3 11V8a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v3M3 11h18v9H3v-9Zm4-7v7m10-7v7m-7 0v4h4v-4"/>',
  take: '<path d="M12 3v11m-4-4 4 4 4-4M4 14v6h16v-6"/>',
  hourglass:
    '<path d="M6 3h12M6 21h12M7 3v4l5 5-5 5v4m10-18v4l-5 5 5 5v4M9 7h6m-6 11h6"/>',
  ...
  center:
    '<circle cx="12" cy="12" r="6"/><path d="M12 2v4m0 12v4M2 12h4m12 0h4"/><circle cx="12" cy="12" r="1"/>',
...
export function iconMarkup(name) {
  if (!Object.hasOwn(paths, name))
    throw new Error(`Unknown interface icon: ${name}`);
...
export function mountIcons(root = document) {
  root
    ...
    .forEach((element) => setIcon(element, element.dataset.icon));
}
